...
template <class T>
constexpr T solve_(i64 p, i64 q, i64 r, i64 l, T a, T b) {
...
template <class Node>
constexpr Node exeuclid(i64 p, i64 q, i64 r, i64 l, Node const &a, Node const &b) { return qpow(a, u64(r / q), Node{}) * exeuclid_impl_::solve_(p, q, r % q, l, a, b); }
