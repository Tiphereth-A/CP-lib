...
i64 ge_basic(Mat &mat, Is0 is0, u32 row_start, u32 row_end, bool clear_u = true) {
...
template <class Mat, class Is0, class T = typename Mat::value_type>
i64 ge_basic(Mat &mat, Is0 is0, bool clear_u = true) { return ge_basic<Mat, Is0, T>(mat, is0, 0, mat.row(), clear_u); }
