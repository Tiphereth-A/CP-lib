...
int main() {
  ...
  switch (tcase) {
    ...
    case unittest::TC::example_01: test("1"); break;
    case unittest::TC::random_00: test("2"); break;
    case unittest::TC::random_01: test("3"); break;
    case unittest::TC::random_02: test("4"); break;
    case unittest::TC::random_03: test("5"); break;
    case unittest::TC::random_04: test("6"); break;
