...
constexpr vec<u32> cantor_val2seq(u64 cv, vec<u64> const &fact) {
  u32 n = (u32)fact.size();
  --cv;
  vec<u32> s;
  s.reserve(n);
...
constexpr vec<u32> cantor_val2seq(u64 cv, u32 n) { return cantor_val2seq(cv, math::gen_fact(n, -1_u64)); }
