...
i64 ge_xor(Mat &mat, Is0, u32 row_start, u32 row_end, bool clear_u = true) {
...
template <class Mat, class Is0>
i64 ge_xor(Mat &mat, Is0 is0, bool clear_u = true) { return ge_xor(mat, is0, 0, mat.row(), clear_u); }
