...
#define TIFA_LIBS_GEO2D_FUNC_SELF0__(self, name, ...) \
  constexpr self &do_##name() __VA_ARGS__;            \
  friend constexpr self name(self lhs) { return lhs.do_##name(); }

#define TIFA_LIBS_GEO2D_FNUC_SELF1__(self, name, rhs_type1, rhs1, ...) \
...
#define TIFA_LIBS_GEO2D_FNUC_iSELF1__(self, name, rhs_type1, rhs1, ...) \
