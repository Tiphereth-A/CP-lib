...
using mint_3ntt0 = tifa_libs::math::mint<tifa_libs::math::mint_s63, 167772161>;
using mint_3ntt1 = tifa_libs::math::mint<tifa_libs::math::mint_s63, 469762049>;
using mint_3ntt2 = tifa_libs::math::mint<tifa_libs::math::mint_s63, 754974721>;
