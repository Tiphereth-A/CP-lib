...
i64 ge_euclid(Mat &mat, Is0 is0, Div div, u32 row_start, u32 row_end, bool clear_u = true) {
...
template <class Mat, class Is0, class Div, class T = typename Mat::value_type>
i64 ge_euclid(Mat &mat, Is0 is0, Div div, bool clear_u = true) { return ge_euclid<Mat, Is0, Div, T>(mat, is0, div, 0, mat.row(), clear_u); }
