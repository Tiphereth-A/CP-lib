...
vec<u64> conv_3ntt_u64(std::tuple<NTT<mint0>, NTT<mint1>, NTT<mint2>> &ntt3, vec<u64> const &l, vec<u64> const &r, u64 mod, u32 ans_size) {
...
template <class mint0, class mint1, class mint2>
vec<u64> conv_3ntt_u64(std::tuple<NTT<mint0>, NTT<mint1>, NTT<mint2>> &ntt3, vec<u64> const &l, vec<u64> const &r, u64 mod) { return conv_3ntt_u64(ntt3, l, r, mod, u32(l.size() + r.size() - 1)); }
template <class mint, class mint0, class mint1, class mint2>
vec<mint> conv_3ntt(std::tuple<NTT<mint0>, NTT<mint1>, NTT<mint2>> &ntt3, vec<mint> const &l, vec<mint> const &r, u32 ans_size) {
...
template <class mint, class mint0, class mint1, class mint2>
vec<mint> conv_3ntt(std::tuple<NTT<mint0>, NTT<mint1>, NTT<mint2>> &ntt3, vec<mint> const &l, vec<mint> const &r) { return conv_3ntt<mint, mint0, mint1, mint2>(ntt3, l, r, u32(l.size() + r.size() - 1)); }
