...
template <class T>
inline poly<T> gen_stirling2_row(u64 n, vec<u64> const& pows, vec<u64> const& ifact) {
...
// stirling2[i] = {n \\brace i}, i=0,1,...,n
template <class T>
inline poly<T> gen_stirling2_row(u64 n) { return gen_stirling2_row<T>(n, gen_pows(n + 1, n, T::value_type::mod()), gen_ifact(n + 1, T::value_type::mod())); }
