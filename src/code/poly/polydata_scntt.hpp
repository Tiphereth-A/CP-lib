...
struct polydata_scntt {
  ...
  explicit constexpr polydata_scntt(usz sz = 1, value_type const &val = value_type{}) : d(sz, val) {}
  ...
  void conv(polydata_scntt const &r, usz ans_size) { d = ans_size < 32 ? conv_naive(d, r.d, ans_size) : conv_cntt(d, r.d, ans_size); }
