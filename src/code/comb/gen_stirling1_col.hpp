...
constexpr poly<T> gen_stirling1_col(u32 n, u32 k, vec<u64> const& fact, vec<u64> const& inv) {
...
// stirling1[i] = {i \\brack k}, i=0,1,...,n
template <class T, bool with_sgn = true>
constexpr poly<T> gen_stirling1_col(u32 n, u32 k) { return gen_stirling1_col<T, with_sgn>(n, k, gen_fact(n + 1, T::value_type::mod()), gen_inv(n + 1, T::value_type::mod())); }
