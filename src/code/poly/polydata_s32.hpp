...
struct polydata_s32 {
  ...
  void conv(polydata_s32 const &r, u32 ans_size) { d = ans_size < 32 ? conv_naive(d, r.d, ans_size) : conv_ntt32(ccore, d, r.d, ans_size); }
  void conv(polydata_s32 const &r) { conv(r, u32(d.size() + r.d.size() - 1)); }
};
