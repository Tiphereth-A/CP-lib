...
template <usz R, usz C>
auto &operator>>(tifa_libs::istream_c auto &is, bitmat<R, C> &bmat) NE { return read_bitmat(is, bmat, R, C); }
template <usz R, usz C>
auto &operator<<(tifa_libs::ostream_c auto &os, bitmat<R, C> CR bmat) NE { return print_bitmat(os, bmat, R, C); }
