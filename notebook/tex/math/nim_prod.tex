...
\begin{figure}[h]
    ...
    \centering
    \includesvg[width=0.6\textwidth]{\fixpath{img/Nimber-multiplication-of-powers-of-two}}
...
\begin{figure}[h]
    \label{img:nim-add}
    \centering
    \includesvg[width=0.6\textwidth]{\fixpath{img/Nimber-addition}}
...
\begin{figure}[h]
    \label{img:nim-prod}
    \centering
    \includesvg[width=0.6\textwidth]{\fixpath{img/Nimber-multiplication}}
