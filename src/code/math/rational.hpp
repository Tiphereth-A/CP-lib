...
struct rational {
  ...
  friend auto &operator>>(tifa_libs::istream_c auto &is, rational &x) NE { return is >> x.num >> x.den; }
  friend auto &operator<<(tifa_libs::ostream_c auto &os, rational CR x) NE { return os << x.num << ' ' << x.den; }
  template <arithm_c U>
