...
using namespace tifa_libs;
using mint_3ntt0 = math::mint<math::mint_sbrt, 167772161>;
using mint_3ntt1 = math::mint<math::mint_sbrt, 469762049>;
using mint_3ntt2 = math::mint<math::mint_sbrt, 754974721>;
