#ifndef TIFALIBS_MATH_MINTDATA_2E61N1
...
class mintdata_2e61n1 {
 ...
 public:
  ...
  constexpr mintdata_2e61n1() {}
  template <std::integral T>
  constexpr mintdata_2e61n1(T v) : v_(mod_(v)) {}

  constexpr raw_type val() const { return v_; }
  constexpr raw_type &data() { return v_; }
  constexpr raw_type const &data() const { return v_; }
  constexpr mintdata_2e61n1 operator-() const { return MOD - v_; }
  constexpr mintdata_2e61n1 &operator+=(mintdata_2e61n1 const &r) {
    v_ = mod_(v_ + r.v_);
    return *this;
  }
  constexpr mintdata_2e61n1 &operator-=(mintdata_2e61n1 const &r) {
