#ifndef TIFALIBS_STR_EX_SUFFIX_AUTOMATON_LIB
#define TIFALIBS_STR_EX_SUFFIX_AUTOMATON_LIB
...
class ex_suffix_automaton {
 ...
 public:
  ...
  CEXP ex_suffix_automaton() NE : sz{1}, st(1) { st[0].len = 0, st[0].link = -1_u32; }
