...
using namespace tifa_libs;
using mint_3nttu640 = math::mint<math::mint_ms, 167772161>;
using mint_3nttu641 = math::mint<math::mint_ms, 469762049>;
using mint_3nttu642 = math::mint<math::mint_ms, 754974721>;
