#ifndef TIFALIBS_FAST_S2U_HU32_LIB
#define TIFALIBS_FAST_S2U_HU32_LIB
...
CEXP u32 strhex2uint_si64(const char* const s) NE {
  ...
  u32 _2 = u32((((((!_1 ? _0 : ((_1 >> 6) * 9) + (_0 ^ _1)) * 0x1001 >> 8) & 0x00FF00FF00FF00FF) * 0x1000001 >> 16) & 0x0000FFFF0000FFFF) * 0x1000000000001 >> 32);
  return _2;
}
