...
class Section:
    ...
    def get_filenames(self, code_root_dir: str, doc_root_dir: str, cvdoc_root_dir: str, test_root_dir: str) -> tuple[str, str, str, str]:
    ...
    def open(self, code_root_dir: str, doc_root_dir: str, cvdoc_root_dir: str, test_root_dir: str, *args, **kwargs) -> tuple[IO, IO, IO, IO]:
        """return IO of code file, doc file and test file"""

        _code, _doc, _cvdoc, _test = self.get_filenames(
            code_root_dir, doc_root_dir, cvdoc_root_dir, test_root_dir)

        f_code = open(_code, *args, **kwargs)
        f_doc = open(_doc, *args, **kwargs)
        f_cvdoc = open(_cvdoc, *args, **kwargs)
        f_test = open(_test, *args, **kwargs)
        return f_code, f_doc, f_cvdoc, f_test
